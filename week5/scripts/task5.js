...
const sortBy = () => {
  ...
  switch (filter) {
    case "templeNameAscending":
      // output(
      //   templeList.sort(function(temple1, temple2){
      ...
      output(templeList.sort((a,b) => {
        let temple_a = a.templeName.toLowerCase();
        let temple_b = b.templeName.toLowerCase();
        if (temple_a < temple_b) 
                return -1;
        else if (temple_a > temple_b) return  1;
            else return 0;
      }));
      break;
